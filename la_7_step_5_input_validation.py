...
# Boto3 function to use Amazon Translate to translate the text on only return the Translated Text
...
def input_validation(item):
    ...
    if SourceLanguageCode == TargetLanguageCode:
        ...
        print("Neither the SourceLanguageCode or the TargetLanguageCode are valid - stopping")
        return False
        ...
        print("The SourceLanguageCode and TargetLanguageCode are both valid - proceeding")
        return True
    else:
